  ...
  return (
    <div className="">
      ...
      <div className="w-full p-6">
        ...
        {loading ? (
          <h1 className="text-3xl font-bold text-center text-primaryBlue">
            Loading...
          </h1>
        ) : event ? (
              ...
              <div className="bg-white w-full h-full rounded-lg shadow-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-6 mt-6">
                  <div>
                    ...
                    <p className="text-gray-600">
                      <span className="font-semibold">Veg/NonVeg:</span>{" "}
                      {event?.is_veg ? "Veg" : "Non Veg"}
                    </p>
                    <p className="text-gray-600">
                    ...
                    <p className="text-gray-600">
                      <span className="font-semibold">Event_ending_date:</span>{" "}
                      {event?.ending_time}
                    </p>
                  </div>
                </div>
