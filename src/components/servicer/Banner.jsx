  ...
  return (
    <div className="custom-banner relative w-full ">
      ...
      <div className="custom-banner-content absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
        <h1 className="custom-banner-heading text-4xl font-serif mb-4">Welcome to Your Servicer Dashboard, {name}</h1>
        <p className="custom-banner-text text-lg mb-4">Start managing your event listings and bookings now!</p>
        <Link to="/eventservicer" className=" px-6 py-3 mt-8 bg-customColorA text-black font-serif rounded-lg hover:bg-customColorD transition duration-300">
        Get Started
      </Link>
      </div>
    </div>
