...
function AllBookings() {
        ...
        content: [
          ...
          },
          {
            text: [
              {
                text:
                  startDate && endDate ? "Report Period: " : "Report Date: ",
                fontSize: 14,
                bold: true,
              },
              {
            ...
            table: {
              ...
              body: [
                ...
                ...bookingsToServicer.map((booking) => [
                  booking.car.name,
                  {
                    text: new Date(booking.slot.date).toLocaleDateString(),
                    alignment: "center",
                  },
                  {
                    text: `₹ ${(booking.event.price_per_person * 0.1).toFixed(
                      0,
                    )}`,
                    alignment: "center",
                  },
  ...
  const bookingsToServicer =
    startDate && endDate ? dateFilteredBookings : filteredbookings;
                      ...
                      <tr className="hover:bg-gray-50" key={index}>
                        ...
                        <td className="px-6 py-4">
                          <p>
                            <div>
                              &#8377;{" "}
                              {(booking.car.price_per_day * 0.1).toFixed(0)}
                            </div>
                          </p>
                        </td>
                        <td className="px-6 py-4">
