...
function NavBar1() {
  ...
  <div className="flex items-center bg-white rounded-full p-2"></div>
      ...
      <ul
        className={
          nav
            ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-customColorA ease-in-out duration-500"
            : "ease-in-out duration-500 fixed left-[-100%]"
        }
      >
        <h1 className="w-full text-3xl font-bold text-[#d4a762] m-4">
          Caterserv
        </h1>
        <Link to="/">
