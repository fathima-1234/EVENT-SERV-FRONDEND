        ...
        <div className="flex flex-col md:flex-row -mx-4">
          <div className="md:flex-1 text-center">
            ...
            <div className="font-serif text-black max-w-7xl text-center  mx-auto px-4 sm:px-6 lg:px-8 mt-6">
              ...
              <h3 className="mb-1 font-serif text-black">
                Place : {event.city}
              </h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center space-x-4 my-4 sm:w-1/2">
          ...
          <div className="flex-1 flex justify-between">
            <div>
              <p className="text-black text-sm sm:text-xl font-semibold mt-3 sm:mt-0">
                price per person
              </p>
        ...
        <div className="">
          <h1 className="text-center py-12 text-3xl font-Playball">
            {" "}
            Our Menus
          </h1>
