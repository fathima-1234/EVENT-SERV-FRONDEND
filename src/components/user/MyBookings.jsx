...
function Bookings() {
  ...
  const stripePromise = loadStripe(
    "pk_test_51OETQdSIwzdmVhzBauVaeNDhXEW06fX5JB6XGaF4BrFmWcg4zyjkfB6slzIvhsVDNlRbK9yW4MBalU1yQkbFOnW900fGKOwaX9",
  );
  ...
  async function getbookings(userId) {
    try {
      ...
      const response = await instance.get(
        `api/stripe/bookings/?user=${userId}`,
      );
  ...
  const handleStatusUpdate = async (bookingId, newStatus) => {
    try {
      ...
      const response = await instance.put(
        `api/stripe/cancelbooking/${bookingId}/`,
        {
                      ...
                      <tr className="hover:bg-gray-50" key={index}>
                        ...
                        <td className="px-6 py-4">
                          <p>
                            <div>
                              &#8377;{" "}
                              {booking.event.price_per_person *
                        ...
                        <td>
                          {booking.status === "pending" ? (
                            ...
                            >
                              <button
                                className="button bg-green-600 text-white py-2 px-4 rounded"
                                type="submit"
                              >
                                Checkout
                              </button>
